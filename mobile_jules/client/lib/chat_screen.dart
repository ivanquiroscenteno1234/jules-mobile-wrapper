            ...
            children: [
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    IconButton(
                      icon: Icon(_isImageMode ? Icons.image : Icons.mic),
                      onPressed: () {
                        setState(() {
                    ...
                    IconButton(
                      icon: Icon(_isImageMode ? Icons.attach_file : (_isListening ? Icons.stop : Icons.mic_none)),
                      onPressed: _isImageMode ? _pickImage : _listen,
                    ),
                    Expanded(
                      child: TextField(
