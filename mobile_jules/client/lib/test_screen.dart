  ...
  Widget _buildRunnerForm() {
    ...
    return Column(
      children: [
        ...
        AnimatedBuilder(
          animation: Listenable.merge([_urlController, _objectiveController]),
          builder: (context, child) {
            final isUrlEmpty = _urlController.text.trim().isEmpty;
            final isObjectiveEmpty = _objectiveController.text.trim().isEmpty;
            final canStart = !isUrlEmpty && !isObjectiveEmpty && !_isRunning;
